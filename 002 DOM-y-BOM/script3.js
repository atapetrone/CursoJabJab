...
console.log(ulEle.firstElementChild.nextElementSibling); //este renglon debe dar lo mismo que el anterior

console.log(liEles[1].nextElementSibling); //Otro ejemplo
console.log(liEles[1].previousElementSibling); //Otro ejemplo con previous
